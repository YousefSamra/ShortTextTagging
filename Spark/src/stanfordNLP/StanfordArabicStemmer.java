...
public class StanfordArabicStemmer{
    
    // for the get_root function
    private static Vector staticFiles ;
    static String  pathToStemmerFiles = new StringBuffer ( System.getProperty ( "user.dir" ) + "\\data\\StemmerFiles" + System.getProperty ( "file.separator" ) ).toString ( );
    ...
    public StanfordArabicStemmer() {
        System.out.println(pathToStemmerFiles);
    ...
    {
        pathToStemmerFiles = new StringBuffer ( System.getProperty ( "user.dir" ) + "\\data\\StemmerFiles" + System.getProperty ( "file.separator" ) ).toString ( );
